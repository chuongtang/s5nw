...
// credit to this blogger :  https://letsbuildui.dev/articles/a-typing-text-effect-with-react-hooks
...
export const useTypingText = ({words, keySpeed = 1000, maxPauseAmount = 10}: 
  ...
  // {words:string[] keySpeed?:number, maxPauseAmount?:number}) => {
  ...
  const letterIndex = useRef<number | null>();
