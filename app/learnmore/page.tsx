  ...
  return (
    ...
    <div>
      <div className="h-96 relative w-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center rounded-lg">
        ...
        <p className="text-center md:text-3xl mt-2 text-lg text-neutral-300 relative z-20">
          Let’s create a peer community  to experience firsthand how an online job interview feels.
        </p>
      </div>
      ...
      <section id="learnMore" className="text-gray-600 body-font">
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4 ">
              <div className="border border-gray-200 p-6 rounded-lg shadow-2xl">
                ...
                <p className="leading-relaxed text-base">AI will deliver an expanding library of top interview questions. Practice, Record, & Post for Review</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-6 rounded-lg shadow-2xl">
          ...
          <a href="/signin">
            <button className={`flex mx-auto mt-16 rounded-full gap-2 p-4 text-slate-500 shadow-[-5px_-5px_10px_rgba(255,_255,_255,_0.8),_5px_5px_10px_rgba(0,_0,_0,_0.25)] transition-all hover:shadow-[-1px_-1px_5px_rgba(255,_255,_255,_0.6),_1px_1px_5px_rgba(0,_0,_0,_0.3),inset_-2px_-2px_5px_rgba(255,_255,_255,_1),inset_2px_2px_4px_rgba(0,_0,_0,_0.3)] hover:text-gray-900`} >Get Started
            </button>
          </a>
        </div>
      </section>
        ...
        <div className="md:px-12 lg:px-28">
          <div className="container m-auto space-y-6 text-gray-600">
            ...
            <div className="justify-center flex text-sm">
              <span className="flex">Copyright © <Logo /> | All right reserved</span>
            </div>
          </div>
        </div>
      </footer>
